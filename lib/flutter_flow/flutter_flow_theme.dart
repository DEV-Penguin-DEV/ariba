...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color green = Color(0xFF4FC132);
  late Color defaultColor = Color(0xFFADADBF);
  late Color textBlack = Color(0xFF292929);
  late Color grayLight = Color(0xFFE3E3E3);
  late Color whiteText = Color(0xFFFFFFFF);
  late Color grayDark = Color(0xFFA8A4A4);
  late Color primaryBtnText = Color(0xFFFFFFFF);
  late Color lineColor = Color(0xFFE0E3E7);
  late Color errorOrAlert = Color(0xFFFF4D4F);
}
...
class MobileTypography extends Typography {
  ...
  String get displaySmallFamily => 'CeraPro';
  ...
  String get headlineMediumFamily => 'CeraPro';
